...
VOID vFillPat16bpp(             // Type FNFILL
PDEV*           ppdev,
...
POINTL*         pptlBrush)      // Pattern alignment
{
    ...
    {
        vPatRealize16bpp(ppdev, rbc.prb);
        pbe = rbc.prb->apbe[IBOARD(ppdev)];
    }
                        ...
                        //   in absolute coordinates
{
    ...
    while ((cyTrg -= cySlice) >= 0)
    {
        ...
        vGet16bppSliceFromScreen(ppdev, ulSSA, ulSEA,
