    ...
    {
        {
            ...
            vFillPat8bppWorkAround(ppdev, c, prcl, rop4, rbc, pptlBrush);
            return;
        }
                        ...
                        //   in absolute coordinates
{
    ...
    while ((cyTrg -= cySlice) >= 0)
    {
        ...
        vGet8bppSliceFromScreen(ppdev, ulSSA, ulSEA,
