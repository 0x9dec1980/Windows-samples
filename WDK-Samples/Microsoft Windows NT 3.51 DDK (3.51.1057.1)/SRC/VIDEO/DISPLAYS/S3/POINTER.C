...
BOOL                bShow)
{
    ...
    if (!bShow)
    {
        ...
        OUTP(BT485_CURSOR_X_LOW,  0);
        OUTP(BT485_CURSOR_X_HIGH, 0);

        // A 'y' value of 1600 should be enough...

        OUTP(BT485_CURSOR_Y_LOW,  1663);
        OUTP(BT485_CURSOR_Y_HIGH, (1663 >> 8));
    }
...
BOOL                bShow)
{
    ...
    else
    {
        ...
        OUTP(0x3c6, 2);
        OUTP(0x3c7, 1663);          // A 'y' value of 1600 should be enough...
