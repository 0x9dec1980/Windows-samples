...

{
    ...
    //
    //  Read the registry to determine machine type.
    //

    ZwGetMachineIdentifierValue( &MachineID );
    ...
    for (j = 0; j <  NUMBER_OF_BAD_CONTROLLERS; j++) {
        ...
        if (controller->DisableWriteCache) {
            ...
            if (modeData == NULL) {
                ...
                DebugPrint((1,
                            "ScsiDisk.ScanForSpecial: Check for write-cache enable failed\n"));
                return;
            }
            ...
            if (length < sizeof(MODE_PARAMETER_HEADER)) {
                ...
                if (length < sizeof(MODE_PARAMETER_HEADER)) {
                    ...
                    DebugPrint((1,
                                "ScsiDisk.ScanForSpecial: Mode Sense failed\n"));
            ...
            if (pageData != NULL) {
                ...
                if (((PMODE_CACHING_PAGE)pageData)->WriteCacheEnable) {
                    ...
                    //
                    // Log that the cache is enabled. Data corruption using this device can occur.
                    //
                    ...
                    if (errorLogEntry != NULL) {
                        ...
                        errorLogEntry->ErrorCode       = IO_WRITE_CACHE_ENABLED;
