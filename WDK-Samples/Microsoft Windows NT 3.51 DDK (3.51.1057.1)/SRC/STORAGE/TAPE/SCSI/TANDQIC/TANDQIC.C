        ...
        case TDC_4222:
            ...
            if (NT_SUCCESS(status)) {
                ...
                if (densityCode == QIC_2GB) {
                    ...
                    tapeGetDriveParams->Compression = (BOOLEAN)tapeData->Flags;
...

{
    ...
    if (type == TAPE_LOGICAL_POSITION) {
        ...
        mediumType       = mediaInfoBuffer->ParameterListHeader.MediumType;
...
Routine Description:
    ...
    This routine "sets" the "drive parameters" of the Tandburg drive
...

{
    if (RtlCompareMemory(InquiryData->VendorId,"TANDBERG",8) == 8) {
        ...
        if (RtlCompareMemory(InquiryData->ProductId," TDC 4222",9) == 9) {
            return TDC_4222;
        }
