...

{
...
#ifdef WINDOWS_FE // I8042InternalDeviceControl()
    ...
    switch (irpSp->Parameters.DeviceIoControl.IoControlCode) {
        ...
        case IOCTL_KEYBOARD_SET_IME_STATUS:
            ...
            I8xPrint((
                0,
                "I8042PRT-I8042InternalDeviceControl: keyboard set ime status\n"
                ));
...

{
    ...
    switch(irpSp->Parameters.DeviceIoControl.IoControlCode) {
        ...
        case IOCTL_KEYBOARD_SET_IME_STATUS:
            ...
            I8xPrint((2, "I8042PRT-I8042StartIo: keyboard set ime status\n"));

            if (OYAYUBI_KEYBOARD(*KeyboardId)) {

                //
                // Set IME mode to keyboard hardware.
                //
                (VOID) I8042SetIMEStatusForOasys(DeviceObject,Irp);
            }
