...

{
    ...
    ULONG i;
#ifdef WINDOWS_FE // I8042KeyboardInterruptService()
        ...
        case ACKNOWLEDGE:
            ...
            if (deviceExtension->KeyboardExtension.CurrentOutput.State
                ...
                if ((OYAYUBI_KEYBOARD(*KeyboardId)) && 
                    (deviceExtension->KeyboardExtension.CurrentOutput.FirstByte == 0xF0)) {
            ...
            } else if ((OYAYUBI_KEYBOARD(*KeyboardId)) && 
                       (deviceExtension->KeyboardExtension.CurrentOutput.State == SendFinalByte)) {
                ...
                deviceExtension->KeyboardExtension.CurrentOutput.State = SendLastByte;
...
#ifdef WINDOWS_FE // I8xInitializeKeyboard()
        ...
        if (deviceExtension->HardwarePresent & KEYBOARD_HARDWARE_PRESENT) {
...
#ifdef WINDOWS_FE // I8xKeyboardConfiguration()
            ...
            if (FAREAST_KEYBOARD(*keyboardId)) {
                ...
                if (pKeyboardTypeInformation == NULL) {
                    ...
                    pKeyboardTypeInformation = &(KeyboardTypeInformation[KEYBOARD_TYPE_DEFAULT-1]);
                }
