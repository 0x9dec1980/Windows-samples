/**********************************************************************/
/* Copyright (C) 1995-1996 Microsoft & Zhong Yi Electronics Corp.     */
/**********************************************************************/
    ...
    int     UIMode)
{
    ...
    if(UIMode == LIN_UI) {
	    ...
	    sImeG.rcCandText.bottom = sImeG.rcCandText.top + COMP_TEXT_Y;
    ...
    HINSTANCE hInstL)
{
    ...
    lpImeL->rcCompText.bottom = lpImeL->rcCompText.top + COMP_TEXT_Y;
    ...
    HINSTANCE hInstance)
{
	...
	if (RegQueryValueEx (hKeyGB, szTrace,
		    (DWORD)NULL,
					(LPDWORD)&ValueType,
