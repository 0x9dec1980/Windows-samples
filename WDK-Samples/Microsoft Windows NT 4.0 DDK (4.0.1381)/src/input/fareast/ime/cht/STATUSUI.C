    ...
    LPPOINT lppt)
{
    ...
    } else if (lppt->x + lpImeL->xStatusWi > sImeG.rcWorkArea.right) {
        lppt->x = (sImeG.rcWorkArea.right - lpImeL->xStatusWi);
    }

    if (lppt->y < sImeG.rcWorkArea.top) {
        lppt->y = sImeG.rcWorkArea.top;
    } else if (lppt->y + lpImeL->yStatusHi > sImeG.rcWorkArea.bottom) {
        lppt->y = (sImeG.rcWorkArea.bottom - lpImeL->yStatusHi);
    }
    ...
    HWND        hUIWnd)
{
    ...
    if (!hIMC) {
        ...
        } else if (lpIMC->ptStatusWndPos.x + lpImeL->xStatusWi >
        ...
        } else if (lpIMC->ptStatusWndPos.y + lpImeL->yStatusHi >
            sImeG.rcWorkArea.right) {
