...
#pragma NDIS_PAGEABLE_FUNCTION(LanceInitialize)
...
#pragma NDIS_PAGEABLE_FUNCTION(LanceRegisterAdapter)
...

#pragma NDIS_PAGEABLE_FUNCTION(LanceInitialInit)
...

#pragma NDIS_PAGEABLE_FUNCTION(AllocateAdapterMemory)
