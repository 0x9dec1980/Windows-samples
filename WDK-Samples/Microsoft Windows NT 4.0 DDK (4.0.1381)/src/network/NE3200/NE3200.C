...

#pragma NDIS_PAGEABLE_FUNCTION(NE3200RegisterAdapter)
...

#pragma NDIS_PAGEABLE_FUNCTION(NE3200AllocateAdapterMemory)
...

#pragma NDIS_PAGEABLE_FUNCTION(NE3200InitializeGlobals)
...

#pragma NDIS_PAGEABLE_FUNCTION(NE3200Initialize)
