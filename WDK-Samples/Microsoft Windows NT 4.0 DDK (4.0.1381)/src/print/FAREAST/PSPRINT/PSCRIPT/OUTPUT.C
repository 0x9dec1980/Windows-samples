...
Routine Description:
    ...
    Output a series of 24.8 format fixed-pointer numbers to a buffer.
...

{
    ...
    while (count-- > 0) {
        ...
        pBuffer += SPRINTF(pBuffer, "%f", va_arg(arglist, LONG));
