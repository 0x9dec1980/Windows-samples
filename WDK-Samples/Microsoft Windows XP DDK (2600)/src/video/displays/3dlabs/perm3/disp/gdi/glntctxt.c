...
LONG    ctxtId)
{
    ...
    if (ctxtId != -1)
    {
        ...
        if (pEntry != NULL)
        {
            ...
            WRITE_GLINT_CTRL_REG (VideoControl, pEntry->VideoControl);
