...
HRESULT CCamMicro::Init(PTSTR ptszMicroDriverName, MCAM_DEVICE_INFO **ppDeviceInfo)
{
    ...
    GET_PROC_ADDRESS(FreeThumbnail);
...
HRESULT CCamMicro::FreeThumbnail(MCAM_DEVICE_INFO *pDeviceInfo, BYTE *pThumb)
{
    CALL_DLL_FUNCTION(FreeThumbnail, (pDeviceInfo, pThumb));
}
