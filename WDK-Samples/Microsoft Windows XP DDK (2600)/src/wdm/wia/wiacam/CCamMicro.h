...
typedef HRESULT (__stdcall *FPFreeThumbnail)(MCAM_DEVICE_INFO *pDeviceInfo, BYTE *pThumb);
...
public:
    ...
    HRESULT FreeThumbnail(MCAM_DEVICE_INFO *pDeviceInfo, BYTE *pThumb);
...
private:
    ...
    FPFreeThumbnail m_pFreeThumbnail;
