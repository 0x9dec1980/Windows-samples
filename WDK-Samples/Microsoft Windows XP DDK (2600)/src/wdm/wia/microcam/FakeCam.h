...
inline VOID MakeFullName(PTSTR ptszFullName, PTSTR ptszPath, PTSTR ptszFileName)
{
    lstrcpy(ptszFullName, ptszPath);
    lstrcat(ptszFullName, TEXT("\\"));
    lstrcat(ptszFullName, ptszFileName);
}
