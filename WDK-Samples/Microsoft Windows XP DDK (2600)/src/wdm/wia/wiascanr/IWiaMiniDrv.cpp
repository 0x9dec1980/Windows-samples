    ...
    LONG                        *plDevErrVal)
{
    ...
    if (hr == S_OK) {
        ...
        if (!pmdtc->bClassDrvAllocBuf) {
            ...
            WIAS_LTRACE(m_pIWiaLog,WIALOG_NO_RESOURCE_ID,WIALOG_LEVEL2,("ScanItem, pmdtc->lPage = %d",pmdtc->lPage));
        }
    }
    ...
    LONG                        *plDevErrVal)
{
    ...
    *plDevErrVal = 0;
    ...
    //
    // for compressed data, or multipage transfers, the mini driver does not know the
    // size of the image, so a trmporary buffer needs to be maintained by the WIA
    // minidriver.
    //

    if (!pmdtc->bClassDrvAllocBuf) {

        LONG lClassDrvAllocSize = pItemContext->lImageSize + pItemContext->lHeaderSize;
        WIAS_LTRACE(m_pIWiaLog,WIALOG_NO_RESOURCE_ID,WIALOG_LEVEL2,("drvAcquireItemData, lImageSize  = %d",pItemContext->lImageSize));
        ...
        //LONG lClassDrvAllocSize = pmdtc->lImageSize + pmdtc->lHeaderSize;
    ...
    BYTE *pWiasContext)
{
    ...
    if (SUCCEEDED(hr)) {
        ...
        if (SUCCEEDED(hr)) {
            ...
            pItemContext->lImageSize           = mdtc.lImageSize;
...
HRESULT CWIAScannerDevice::BuildRootItemProperties()
{
    ...
    if(m_bADFAttached){
        m_NumRootItemProperties = 19;   // standard properties + ADF specific
    } else {
        m_NumRootItemProperties = 10;    // standard properties only
    }

    WIAS_LTRACE(m_pIWiaLog,WIALOG_NO_RESOURCE_ID,WIALOG_LEVEL2,("CMicroDriverAPI::BuildRootItemProperties, Number of Properties = %d",m_NumRootItemProperties));
    ...
    m_pszRootItemDefaults[PropIndex]              = WIA_DPS_HORIZONTAL_BED_SIZE_STR;
    m_piRootItemDefaults [PropIndex]              = WIA_DPS_HORIZONTAL_BED_SIZE;
    m_pvRootItemDefaults [PropIndex].lVal         = RootItemInfo.ScanBedWidth;
    ...
    m_pszRootItemDefaults[PropIndex]              = WIA_DPS_VERTICAL_BED_SIZE_STR;
    m_piRootItemDefaults [PropIndex]              = WIA_DPS_VERTICAL_BED_SIZE;
    m_pvRootItemDefaults [PropIndex].lVal         = RootItemInfo.ScanBedHeight;
    m_pvRootItemDefaults [PropIndex].vt           = VT_I4;
    m_psRootItemDefaults [PropIndex].ulKind       = PRSPEC_PROPID;
    m_psRootItemDefaults [PropIndex].propid       = m_piRootItemDefaults [PropIndex];
    m_wpiRootItemDefaults[PropIndex].lAccessFlags = WIA_PROP_READ|WIA_PROP_NONE;
    ...
    m_pvRootItemDefaults [PropIndex].lVal               = WIA_SHOW_PREVIEW_CONTROL;
    m_pvRootItemDefaults [PropIndex].vt                 = VT_I4;
    m_psRootItemDefaults [PropIndex].ulKind             = PRSPEC_PROPID;
    m_psRootItemDefaults [PropIndex].propid             = m_piRootItemDefaults [PropIndex];
    m_wpiRootItemDefaults[PropIndex].lAccessFlags       = WIA_PROP_READ|WIA_PROP_NONE;
    ...
    if(m_bADFAttached) {
        ...
        m_pszRootItemDefaults[PropIndex]              = WIA_DPS_VERTICAL_SHEET_FEED_SIZE_STR;
        m_piRootItemDefaults [PropIndex]              = WIA_DPS_VERTICAL_SHEET_FEED_SIZE;
        m_pvRootItemDefaults [PropIndex].lVal         = RootItemInfo.DocumentFeederHeight;
        m_pvRootItemDefaults [PropIndex].vt           = VT_I4;
        m_psRootItemDefaults [PropIndex].ulKind       = PRSPEC_PROPID;
        m_psRootItemDefaults [PropIndex].propid       = m_piRootItemDefaults [PropIndex];
        m_wpiRootItemDefaults[PropIndex].lAccessFlags = WIA_PROP_READ|WIA_PROP_NONE;
        ...
        m_pvRootItemDefaults [PropIndex].lVal         = FLATBED;
        m_pvRootItemDefaults [PropIndex].vt           = VT_I4;
        m_psRootItemDefaults [PropIndex].ulKind       = PRSPEC_PROPID;
        m_psRootItemDefaults [PropIndex].propid       = m_piRootItemDefaults [PropIndex];
...
HRESULT CWIAScannerDevice::BuildTopItemProperties()
{
    ...
    m_wpiItemDefaults[PropIndex].lAccessFlags       = WIA_PROP_RW|WIA_PROP_RANGE;
    m_wpiItemDefaults[PropIndex].vt                 = m_pvItemDefaults [PropIndex].vt;
    m_wpiItemDefaults[PropIndex].ValidVal.Range.Inc = 1;
    m_wpiItemDefaults[PropIndex].ValidVal.Range.Min = 1;
    m_wpiItemDefaults[PropIndex].ValidVal.Range.Max = m_pvItemDefaults [PropIndex].lVal;
    m_wpiItemDefaults[PropIndex].ValidVal.Range.Nom = m_pvItemDefaults [PropIndex].lVal;

    PropIndex++;

    // Intialize WIA_IPS_YEXTENT (RANGE)
    m_pszItemDefaults[PropIndex]                    = WIA_IPS_YEXTENT_STR;
    m_piItemDefaults [PropIndex]                    = WIA_IPS_YEXTENT;
    m_pvItemDefaults [PropIndex].lVal               = ((m_pvItemDefaults [PropIndex-2].lVal * RootItemInfo.ScanBedHeight)/1000);
    m_pvItemDefaults [PropIndex].vt                 = VT_I4;
    m_psItemDefaults [PropIndex].ulKind             = PRSPEC_PROPID;
    m_psItemDefaults [PropIndex].propid             = m_piItemDefaults [PropIndex];
    m_wpiItemDefaults[PropIndex].lAccessFlags       = WIA_PROP_RW|WIA_PROP_RANGE;
    ...
    m_wpiItemDefaults[PropIndex].vt                 = m_pvItemDefaults [PropIndex].vt;
    m_wpiItemDefaults[PropIndex].ValidVal.Range.Inc = 1;
    m_wpiItemDefaults[PropIndex].ValidVal.Range.Min = 0;
    m_wpiItemDefaults[PropIndex].ValidVal.Range.Max = (m_wpiItemDefaults[PropIndex-2].ValidVal.Range.Max - 1);
    m_wpiItemDefaults[PropIndex].ValidVal.Range.Nom = m_pvItemDefaults [PropIndex].lVal;
    ...
    m_pvItemDefaults [PropIndex].lVal               = m_pvItemDefaults [PropIndex-9].lVal;
    m_pvItemDefaults [PropIndex].vt                 = VT_I4;
    m_psItemDefaults [PropIndex].ulKind             = PRSPEC_PROPID;
    m_psItemDefaults [PropIndex].propid             = m_piItemDefaults [PropIndex];
    m_wpiItemDefaults[PropIndex].lAccessFlags       = WIA_PROP_READ|WIA_PROP_NONE;
...
HRESULT CWIAScannerDevice::BuildSupportedFormats()
{
    ...
    if (SUCCEEDED(hr)) {
        ...
        if (m_pSupportedFormats) {
            ...
            m_pSupportedFormats[3].lTymed       = TYMED_MULTIPAGE_FILE;
            m_pSupportedFormats[4].guidFormatID = WiaImgFmt_TIFF;
            m_pSupportedFormats[4].lTymed       = TYMED_MULTIPAGE_CALLBACK;
        } else
            hr = E_OUTOFMEMORY;
    }
    return hr;
...
HRESULT CWIAScannerDevice::BuildSupportedTYMED()
{
    ...
    if (SUCCEEDED(hr)) {
        ...
        if (m_pSupportedTYMED) {
            ...
            m_pSupportedTYMED[2] = TYMED_MULTIPAGE_FILE;
            m_pSupportedTYMED[3] = TYMED_MULTIPAGE_CALLBACK;
        } else
            hr = E_OUTOFMEMORY;
    }
    return hr;
...

{
    ...
    BITMAPINFOHEADER UNALIGNED *pbmih = NULL;
