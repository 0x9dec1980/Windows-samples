    ...
    )
{
    ...
    WCHAR               scratchBuffer[SMB_MAX_DATA_SIZE];
    WCHAR               buffer2[SMB_MAX_DATA_SIZE];
//    UCHAR               strBuffer[SMB_MAX_DATA_SIZE];
//    UCHAR               strBuffer2[SMB_MAX_DATA_SIZE];
//    UCHAR               strLength;
    UNICODE_STRING      unicodeString;
    UNICODE_STRING      tmpUnicodeString;
    ANSI_STRING         ansiString;
    ULONG               scratchUlong[2];
    ULONG               oldSelectorState;
//    UCHAR               BattCommand;
        ...
        do {
            ...
            switch (Level) {
                ...
                case BatteryGranularityInformation:
                    SmbBattRW(SmbBatt, BAT_FULL_CHARGE_CAPACITY, &scratchUlong[1]);
                    scratchUlong[0]     *= SmbBatt->Info.PowerScale;
                    ReturnBuffer        = &scratchUlong[0];
                    ReturnBufferLength  = sizeof (scratchUlong);
                    break;
                ...
                case BatteryDeviceName:
                    ...
                    unicodeString.MaximumLength = SMB_MAX_DATA_SIZE;

                    RtlInitAnsiString (&ansiString, SmbBatt->Info.DeviceName);
                ...
                case BatteryManufactureName:
                    ...
                    RtlInitAnsiString (&ansiString, SmbBatt->Info.ManufacturerName);
                    RtlAnsiStringToUnicodeString (&unicodeString, &ansiString, FALSE);
                    ReturnBuffer        = unicodeString.Buffer;
                    ReturnBufferLength  = unicodeString.Length;
                    break;
                ...
                case BatteryUniqueID:
                    ...
                    tmpUnicodeString.MaximumLength  = SMB_MAX_DATA_SIZE;
